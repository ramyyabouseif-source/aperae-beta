    ...
    <View style={styles.card}>
      ...
      <View style={styles.disclaimer}>
        <Text style={styles.disclaimerText}>
          <Text style={styles.disclaimerBold}>AI-Generated Recommendation:</Text> This recommendation is generated by artificial intelligence (Anthropic Claude) for informational and entertainment purposes only. Not professional sommelier advice. Prices, ratings, and availability are estimates and may be incorrect. Verify wine details before purchasing.
        </Text>
      </View>
    </View>
  );
