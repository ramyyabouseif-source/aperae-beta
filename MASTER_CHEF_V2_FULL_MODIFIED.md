# Master Chef Prompt V2.0 - FULL VERSION (Modified)
# Modified: v7.1 → v7.0, Added PREPARATION & SAUCE PRIORITY
...
A. PREPARATION & SAUCE PRIORITY (20% weight - REVERSE): Dish cooking method and sauce determine structural requirements, which must match wine structure. When recommending dishes, the cooking method and sauce are the PRIMARY determinants of what the wine structure must support. Rationale must state: (1) method impact on dish, (2) sauce dictates wine structure needs, (3) overrides protein alone.
...
E. TANNIN-UMAMI SCENARIOS (REVERSE - CRITICAL)
...
M. TIER 1 VIOLATIONS (MASTER LIST - from Sommelier v7.0)
...
• +10: Zero Tier 1 violations (see Section 2.M)
...
DEDUCTIONS:
• -15: Tier 1 violation (any from Section 2.M)
• -10: Missing critical principle (e.g., Preparation & Sauce Priority, tannin-protein for high tannin wine)
...
• Zero Tier 1 violations from Section 2.M master list
