/**
 * V7.0 Master Sommelier Prompt - Static Sections (Cacheable)
 * 
 * These sections can be cached by Anthropic for 1 hour since they don't change
 * between requests. This reduces token usage and improves response time.
 */

const STATIC_SECTIONS = {
  /**
   * Section 2: Core Pairing Principles
   * Contains all the pairing rules and decision trees
   */
  pairingPrinciples: `
...
High tannins ONLY with: fatty red meats, aged hard cheese, grilled/charred proteins with substantial fat AVOID: delicate fish, raw/poached, vegetables, Scenario 2/3
...
•	Terpenes (α-pinene family): Rosemary, sage (NOT basil, NOT thyme beyond trace amounts) → Vermentino, Syrah, Grüner Veltliner 
