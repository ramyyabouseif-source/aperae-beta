          ...
          <View style={styles.recommendationsSection}>
            ...
            <View style={styles.aiDisclaimerBanner}>
              <Text style={styles.aiDisclaimerText}>
                <Text style={styles.aiDisclaimerBold}>AI-Generated Recommendations:</Text> These recommendations are generated by artificial intelligence (Anthropic Claude) for informational and entertainment purposes only. Not professional sommelier advice. Verify wine details before purchasing.
              </Text>
            </View>
